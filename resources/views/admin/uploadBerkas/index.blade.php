                          ...
                          <table class="table table-striped table-bordered table-md" id="data-pemohon">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="/uploadBerkas/upload/{{ $row->id }}" class="btn btn-outline-primary" style="font-weight: bold;font-size: 13px;border-radius: 0px;border-width: 1.5px;"><i class="fas fa-upload"></i></a>
                                        <a href="/uploadBerkas/view/{{ $row->id }}" class="btn btn-outline-info" style="font-weight: bold;font-size: 13px;border-radius: 0px;border-width: 1.5px;"><i class="fas fa-eye"></i></a>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
