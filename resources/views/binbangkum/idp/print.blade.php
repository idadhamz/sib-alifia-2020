...
<html>
<head>
  <title>Print Out Izin Dinas Perpanjangan</title>
...
<body style="margin-top: 30px;">
  ...
  <p style="text-align: center;">
    <span style="line-height: 35px;font-size: 22px;font-weight: bold;text-transform: uppercase;text-decoration: underline;">IZIN DINAS PERPANJANGAN</span><br> <span style="line-height: 35px;font-size: 18px;font-weight: bold;text-transform: uppercase;text-decoration: none;">No. 1/IDP/X.3/{{ date('m') }}/{{ date('Y') }}</span>
  </p>

  @foreach($data_idp_print as $row)
