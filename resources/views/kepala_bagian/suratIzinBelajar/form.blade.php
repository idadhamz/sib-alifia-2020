                  ...
                  <div class="col-12">
                    <div class="card">
                      ...
                      <div class="card-body">
                        ...
                        <div class="row">
                          <div class="col-8">
                            @foreach($data_permohonan_surat_create as $row)
                            <form action="/suratIzinBelajar/store" method="post" role="form" enctype="multipart/form-data">
                              {{csrf_field()}}
                              ...
                              <div class="form-group">
                                <label>Upload Surat Izin Belajar</label>
                                <input type="file" class="form-control" name="surat_izin_belajar" style="height: auto;">
                          ...
                          <div class="card-footer" style="padding: 20px 0px;">
                            ...
                            <div style="float: left;">
                              <a href="{{url('/suratIzinBelajar/index')}}" class="btn btn-warning">Kembali</a>
                            </div>
