            ...
            <section class="section">
              <div class="section-header">
                    ...
                    <div class="section-header-breadcrumb">
                      ...
                      <div class="breadcrumb-item"><a href="{{url('/cetakIdp/index')}}">Cetak IDP</a></div>
                  </div>
              </div>
                  ...
                  <div class="col-12">
                    ...
                    <div class="card-body">
                        <div style="margin:0px 0px 10px 0px;"> 
                            <a href="{{url('/cetakIdp/index')}}"class="btn btn-outline-primary" style="font-weight: bold;font-size: 13px;border-radius: 0px;border-width: 1.5px;">Muat Ulang</a>
                        </div>
                        <hr/>
